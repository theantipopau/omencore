...
{
    /// <summary>
    /// Enhanced Corsair device service with SDK abstraction layer.
    /// Supports both stub and real iCUE SDK implementations.
    /// </summary>
    public class EnhancedCorsairDeviceService : IDisposable
    {
        ...
        /// </summary>
        public EnhancedCorsairDeviceService(ICorsairSdkProvider sdkProvider, LoggingService logging)
        {
            _sdk = sdkProvider;
            _logging = logging;
        ...
        /// </summary>
        public static async Task<EnhancedCorsairDeviceService> CreateAsync(LoggingService logging)
        {
