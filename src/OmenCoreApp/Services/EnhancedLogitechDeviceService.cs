...
{
    /// <summary>
    /// Enhanced Logitech device service with SDK abstraction layer.
    /// Supports both stub and real G HUB SDK implementations (WIP).
    /// </summary>
    public class EnhancedLogitechDeviceService : IDisposable
    {
        ...
        /// </summary>
        public EnhancedLogitechDeviceService(ILogitechSdkProvider sdkProvider, LoggingService logging)
        {
            _sdk = sdkProvider;
            _logging = logging;
        ...
        /// </summary>
        public static async Task<EnhancedLogitechDeviceService> CreateAsync(LoggingService logging)
        {
            ...
            var service = new EnhancedLogitechDeviceService(sdk, logging);
