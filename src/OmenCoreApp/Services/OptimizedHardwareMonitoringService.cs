...
{
    /// <summary>
    /// Optimized hardware monitoring service with performance enhancements.
    /// Features: Object pooling, change detection, adaptive polling, low-overhead mode.
    /// </summary>
    public class OptimizedHardwareMonitoringService : IDisposable
    {
        ...
        public OptimizedHardwareMonitoringService(IHardwareMonitorBridge bridge, LoggingService logging, MonitoringPreferences preferences)
        {
            _bridge = bridge;
            _logging = logging;
