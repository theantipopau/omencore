# OmenCore v2.9.1 — UI Freeze Hotfix

**Release Date:** 2026-02-15
**Type:** Hotfix
**Reported By:** Users reporting "app opens but no telemetry / spinning wheel / tray unresponsive"

---

## Bug Fixes

### 1. UI Freeze on Startup Due to Synchronous Keyboard Lighting Initialization
- **Symptom:** App starts but UI freezes with spinning wheel, no telemetry updates, tray unresponsive.
- **Root Cause:** KeyboardLightingService.SetAllZoneColors was blocking the UI thread synchronously during startup color restoration.
- **Fix:** Converted synchronous .GetAwaiter().GetResult() calls to proper async/await pattern in keyboard lighting methods.
- **Files:** KeyboardLightingService.cs, LightingViewModel.cs, TemperatureRgbService.cs, MainViewModel.cs
...
| File | Size |
|------|------|
| `OmenCoreSetup-2.9.1.exe` | Windows installer (recommended) |
| `OmenCore-2.9.1-win-x64.zip` | Windows portable |
| `OmenCore-2.9.0-linux-x64.zip` | Linux portable (CLI + Avalonia GUI) |

## SHA256 Checksums

```
DA81E71516925994272A165485DE455364E5684836FAD09CF263FA0C969470A5  OmenCoreSetup-2.9.1.exe
04D064F3899F24784F77316DDD9B05AFE67803976C9C44AB67D39FEB7DBF2D46  OmenCore-2.9.1-win-x64.zip
...
```</content>
<parameter name="filePath">f:\Omen\docs\CHANGELOG_v2.9.1.md