...
| File | SHA256 |
|------|--------|
| `OmenCoreSetup-2.7.0.exe` | `7BB27ADC...C157A2` |
| `OmenCore-2.7.0-win-x64.zip` | `E3334290...F35EB9` |
| `OmenCore-2.7.0-linux-x64.zip` | `F6C7BB52...C7BE29` |

Full changelog: https://github.com/theantipopau/omencore/blob/main/docs/CHANGELOG_v2.7.0.md
